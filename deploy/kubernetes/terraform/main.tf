...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    yor_trace = "3c216287-cac4-402e-81fd-c6cc2128e1b5"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    yor_trace = "0a7a01bd-fd8b-4236-9906-1ff0ec08252c"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    yor_trace = "f776b827-2a14-457a-a322-35cf41a3c8b7"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    yor_trace = "709f0259-72e5-4098-ab8c-c798c0e0acc4"
  }
}
